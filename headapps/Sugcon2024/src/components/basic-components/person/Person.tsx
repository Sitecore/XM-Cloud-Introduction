  ...
  return (
    <Box mb={30} w={props.isPeopleGrid ? 300 : 260}>
      ...
      {props.params?.LinkToBio == '1' && (
        <Button onClick={onOpen} variant="link">
          <Heading as="h3" size="md" mt={2}>
            <ContentSdkText field={props.fields.Name} />
          </Heading>
        </Button>
      )}
      ...
      <Text className="person-job-role" mb={0}>
        <ContentSdkText field={props.fields.JobRole} />
      </Text>
      <Text className="person-company" mb="13px">
        <ContentSdkText field={props.fields.Company} />
      </Text>
      {(page.mode.isEditing ||
      ...
      {page.mode.isEditing && (
        <Text fontSize="12px" mb={0}>
          <ContentSdkText field={props.fields.Biography} />
        </Text>
      )}
      {props.params?.LinkToBio == '1' && (
            ...
            <ModalBody>
              <Flex flexWrap="wrap">
                ...
                <Box w={{ base: '100%', md: '55%', lg: '60%' }}>
                  ...
                  <Text as={ContentSdkRichText} fontSize="18px" mb="15px" field={props.fields.Biography} />
                </Box>
              </Flex>
            </ModalBody>
